...
```bash
npm install @taktikorg/repellat-omnis --save-dev
```

  Once installed it can now be referenced by simply calling ```require('@taktikorg/repellat-omnis');```
...
```js
const request = require('@taktikorg/repellat-omnis');
...
Anything you can do with superagent, you can do with @taktikorg/repellat-omnis - for example multipart file uploads!
...
[coverage-badge]: https://img.shields.io/codecov/c/github/ladjs/@taktikorg/repellat-omnis.svg
[coverage]: https://codecov.io/gh/ladjs/@taktikorg/repellat-omnis
[travis-badge]: https://travis-ci.org/ladjs/@taktikorg/repellat-omnis.svg?branch=master
[travis]: https://travis-ci.org/ladjs/@taktikorg/repellat-omnis
[dependencies-badge]: https://david-dm.org/ladjs/@taktikorg/repellat-omnis/status.svg
[dependencies]: https://david-dm.org/ladjs/@taktikorg/repellat-omnis
[prs-badge]: https://img.shields.io/badge/PRs-welcome-brightgreen.svg?style=flat-square
[prs]: http://makeapullrequest.com
[license-badge]: https://img.shields.io/badge/license-MIT-blue.svg?style=flat-square
[license]: https://github.com/taktikorg/repellat-omnis/blob/master/LICENSE
